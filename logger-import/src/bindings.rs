...
pub mod component {
    pub mod recorder {
        ...
        pub mod logging {
            ...
            pub fn record(method: &str, args: &str, ret: &str) -> () {
                unsafe {
                    let vec0 = method;
                    ...
                    #[link(wasm_import_module = "component:recorder/logging")]
                    unsafe extern "C" {
                        #[link_name = "record"]
                        fn wit_import3(
                            _: *mut u8,
            ...
            pub mod res {
                ...
                impl Res {
                    ...
                    pub fn new<T: GuestRes>(val: T) -> Self {
                        ...
                        let ptr: *mut _ResRep<T> = _rt::Box::into_raw(
                            _rt::Box::new(val),
                        );
                ...
                unsafe impl _rt::WasmResource for Res {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]docs:calculator/res@0.1.0"
                            )]
                            unsafe extern "C" {
                                #[link_name = "[resource-drop]res"]
                                fn drop(_: u32);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_constructor_res_cabi<T: GuestRes>() -> i32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = Res::new(T::new());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_res_write_cabi<T: GuestRes>(
                    arg0: *mut u8,
                    arg1: i32,
                ) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    T::write(
                        unsafe { ResBorrow::lift(arg0 as u32 as usize) }.get(),
                        arg1 as u32,
                    );
                }
                #[doc(hidden)]
                ...
                macro_rules! __export_docs_calculator_res_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "docs:calculator/res@0.1.0#[constructor]res")] unsafe extern "C"
                        fn export_constructor_res() -> i32 { unsafe {
                        $($path_to_types)*:: _export_constructor_res_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Res > () } } #[unsafe (export_name
                        = "docs:calculator/res@0.1.0#[method]res.write")] unsafe extern
                ...
                #[doc(hidden)]
                pub(crate) use __export_docs_calculator_res_0_1_0_cabi;
            }
        }
    }
}
...
macro_rules! __export_imports_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::docs::calculator::res::__export_docs_calculator_res_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::docs::calculator::res);
        $($path_to_types_root)*::
